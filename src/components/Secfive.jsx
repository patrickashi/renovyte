...
const Secfive = () => {
    return (
        <div className="bg-[#fffeed] w-full pt-32 pb-24 px-2 md:px-10 lg:px-16">
            ...
            <h2 className="text-4xl mb-8 w-full md:w-[600px]">We Offer a Range of Remodeling Services to Meet Every Need</h2>
            <div className="flex flex-col md:flex-row gap-4 text-white  justify-between">
